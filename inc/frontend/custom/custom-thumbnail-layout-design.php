...
<?php if (!empty($design_settings['member_layout_overlay_color'])) { ?>
        #ttp-wrapper-<?php echo $layout_type; ?>-<?php echo $random_num; ?> .ttp-inner-whole-wrapper .ttp-thumb-image .ttp-expand-popup-click,
        #ttp-wrapper-<?php echo $layout_type; ?>-<?php echo $random_num; ?> .ttp-inner-whole-wrapper .ttp-inner-whole-wrapper .ttp-thumb-image .ttp-expand-slide-out-click{
...
if (!empty($design_settings['member_layout_expand_icon_color'])):
    ?>
        #ttp-wrapper-<?php echo $layout_type; ?>-<?php echo $random_num; ?> .ttp-inner-whole-wrapper .ttp-grid-image .ttp-expand-slide-out-click fa,
        #ttp-wrapper-<?php echo $layout_type; ?>-<?php echo $random_num; ?> .ttp-inner-whole-wrapper .ttp-grid-image .ttp-expand-popup-click .fa
        {
...
<?php if (!empty($design_settings['quote_text_color'])): ?>        
        #ttp-wrapper-<?php echo $layout_type; ?>-<?php echo $random_num; ?> .ttp-inner-whole-wrapper .ttp-content-quote,
...
<?php if (!empty($design_settings['external_link_color'])): ?> 
        #ttp-wrapper-<?php echo $layout_type; ?>-<?php echo $random_num; ?> .ttp-content-inner-link-list a
        {
...
<?php if (!empty($design_settings['external_link_hover_visited_color'])): ?> 
        #ttp-wrapper-<?php echo $layout_type; ?>-<?php echo $random_num; ?> .ttp-content-inner-link-list a:hover
        {
...
<?php if (!empty($design_settings['skill_bar_color'])): ?>   
        #ttp-wrapper-<?php echo $layout_type; ?>-<?php echo $random_num; ?> .ttp-content-skill-list-wrap .ttp-content-skill-list .ttp-bar-skill-title .sb_bar,
        #ttp-wrapper-<?php echo $layout_type; ?>-<?php echo $random_num; ?> .ttp-content-skill-list .ttp-bar-skill-title .sb_bar:before{
...
<?php if (!empty($design_settings['skill_bar_bg_color'])): ?> 
        #ttp-wrapper-<?php echo $layout_type; ?>-<?php echo $random_num; ?> .ttp-content-skill-list-wrap .ttp-content-skill-list .ttp-bar-skill-title.sb_progress{
...
<?php if (!empty($design_settings['skill_bar_text_color'])): ?> 
        #ttp-wrapper-<?php echo $layout_type; ?>-<?php echo $random_num; ?> .ttp-content-skill-list-top .ttp-skill-label,
        #ttp-wrapper-<?php echo $layout_type; ?>-<?php echo $random_num; ?> .ttp-content-skill-list-top .ttp-skill-value
        {
